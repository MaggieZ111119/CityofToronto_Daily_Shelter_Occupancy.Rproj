...
COVID-19 is inded empacting on homeless populations, and the effor of mainting thier living needs is a continuse effort even 5 years after the outbreak. This data contains evidence for govemetn support during the pendemic, but is not inclusive enought to evluated on their performance on shelter servises. This defeinlty reqire more rigours research. And it's also not enought to say about what is the govement' support now, since this data only untill 2020. ALso, the increase untillization rate during covid outbreak could be the case that more people are facing more severe peoeblems so that not even make it to the shelter. 
Understanidng the well-velopneness and imparotance of support networks among people experiencing homelessness is sessential. A more cirtical proalblem comes along it how should the supporte being delievered. A good way to to support while ensuring not to disrupt them, for instance by avoiding practices that displace or isolate people from their communities such as moving people to shelters located far from their usual supports @boucher2022they. This is defienlt a long journey to go.
